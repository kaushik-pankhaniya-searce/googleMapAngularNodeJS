...
(function() {
  ...
  angular.module('cfp.hotkeys', []).provider('hotkeys', function() {
    ...
    this.template = '<div class="cfp-hotkeys-container fade" ng-class="{in: helpVisible}" style="display: none;"><div class="cfp-hotkeys">' +
                        ...
                        '<div class="in-gs-btn" align="center"></div>' +
                        '</div>'+
                        '<div class="col-md-6 col-sm-12 col-xs-12">' +
                          '<h4 class="cfp-hotkeys-title">Shortcut Keys</h4>' +
                          '<table><tbody>' +
                        ...
                        '<div class="col-md-6 col-sm-12 col-xs-12">' +
                          ...
                          '<div ng-bind-html="helpContent" class="overflow-auto" style="max-height: 500px;"></div>'+
//                        '<h4 class="cfp-hotkeys-title">Current State</h4>' +
//                        '<label>{{$state.current.title}}</label>' +
//                        '<iframe src="helpContent.html" ></iframe>' +
                        '</div>' +
                      '<div class="cfp-hotkeys-close" ng-click="toggleCheatSheet()">×</div>' +
                      '<div class="cfp-hotkeys-help-button"><h3><a href="http://support.invoize.com" target="_blank" class="in-btn" style="color:#FFFFFF;">Click here</a> &nbsp;For Helpdesk Support</h3></div>'
                    '</div></div>';
